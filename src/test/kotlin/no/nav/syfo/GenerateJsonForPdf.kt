...
fun main() {
    ...
    val receivedSykmelding = ReceivedSykmelding(sykmelding, "123456789", "123456789", "abcdef", "abcdef", "98765432", "123456789", "546372819", "Legekontor AS", LocalDateTime.now(), "1", "<xml/>")
    val person = Person()
